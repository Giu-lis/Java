...
public class Jogodavelha {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println(nomeJogadorAtual +" (" + jogadorAtual + ") " + "digite a linha: ");
            int linha = ler.nextInt();
            System.out.println(nomeJogadorAtual + " (" + jogadorAtual + ") "+ "digite a coluna: ");
            ...
            if (!vencedor.equals("")) {
                mostrarTabuleiro(tabuleiro);
                System.out.println(vencedor + " venceu o jogo.");
                break;
            }
            if (jogadas == 9) {
                mostrarTabuleiro(tabuleiro);
